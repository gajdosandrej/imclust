...
DESCRIPTION
    Image clusteuring demo imclust_spectral_v1.py will cluster images in
...
VERSION
    ...
    imclust_spectral_v1.py - extended version of imclust.py (by A. Gajdos) 
"""
...
for i in range(len(models)): 
    ...
    plt.savefig(output_dataset_path + '\MSC_' + models_names[i] + '_spectral.png')

    frame.to_csv(output_dataset_path + '\MSC_' + models_names[i] + '_spectral.txt', index=None, sep='\t', mode='a')
...
for i in range(len(models)): 
    ...
    plt.savefig(output_dataset_path + '\CHS_' + models_names[i] + '_spectral.png')

    frame.to_csv(output_dataset_path + '\CHS_' + models_names[i] + '_spectral.txt', index=None, sep='\t', mode='a')
...
for i in range(len(models)): 
    ...
    plt.savefig(output_dataset_path + '\DBS_' + models_names[i] + '_spectral.png')

    frame.to_csv(output_dataset_path + '\DBS_' + models_names[i] + '_spectral.txt', index=None, sep='\t', mode='a')
...
for i in range(len(models)): 
    ...
    plt.savefig(output_dataset_path + '\COP_' + models_names[i] + '_spectral.png')

    frame.to_csv(output_dataset_path + '\COP_' + models_names[i] + '_spectral.txt', index=None, sep='\t', mode='a')
...
for i in range(len(models)): 
    ...
    plt.savefig(output_dataset_path + '\SDbw_' + models_names[i] + '_spectral.png')

    frame.to_csv(output_dataset_path + '\SDbw_' + models_names[i] + '_spectral.txt', index=None, sep='\t', mode='a')
...
for i in range(len(models)):
    for j in range(len(CLUSTERS)):
        ...
        with open(output_dataset_path + "\index_" + models_names[i] + "_spectral"+str(CLUSTERS[j])+".html","w") as fd:
            fd.write(html)
