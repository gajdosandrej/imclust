...
for i in range(len(models)): 
    ...
    plt.savefig('clustering_outputs\MSC_' + models_names[i] + '_dbscan.png')

    frame.to_csv(r'clustering_outputs\MSC_' + models_names[i] + '_dbscan.txt', index=None, sep='\t', mode='a') 
    ...
    plt.savefig('clustering_outputs\MSC_wo_' + models_names[i] + '_dbscan.png')

    frame.to_csv(r'clustering_outputs\MSC_wo_' + models_names[i] + '_dbscan.txt', index=None, sep='\t', mode='a')
...
for i in range(len(models)): 
    ...
    plt.savefig('clustering_outputs\CHS_' + models_names[i] + '_dbscan.png')

    frame.to_csv(r'clustering_outputs\CHS_' + models_names[i] + '_dbscan.txt', index=None, sep='\t', mode='a') 
    ...
    plt.savefig('clustering_outputs\CHS_wo_' + models_names[i] + '_dbscan.png')

    frame.to_csv(r'clustering_outputs\CHS_wo_' + models_names[i] + '_dbscan.txt', index=None, sep='\t', mode='a')
...
for i in range(len(models)): 
    ...
    plt.savefig('clustering_outputs\DBS_' + models_names[i] + '_dbscan.png')

    frame.to_csv(r'clustering_outputs\DBS_' + models_names[i] + '_dbscan.txt', index=None, sep='\t', mode='a')
    ...
    plt.savefig('clustering_outputs\DBS_wo_' + models_names[i] + '_dbscan.png')

    frame.to_csv(r'clustering_outputs\DBS_wo_' + models_names[i] + '_dbscan.txt', index=None, sep='\t', mode='a')
...
for i in range(len(models)): 
    ...
    plt.savefig('clustering_outputs\COP_' + models_names[i] + '_dbscan.png')

    frame.to_csv(r'clustering_outputs\COP_' + models_names[i] + '_dbscan.txt', index=None, sep='\t', mode='a')
    ...
    plt.savefig('clustering_outputs\COP_wo_' + models_names[i] + '_dbscan.png')

    frame.to_csv(r'clustering_outputs\COP_wo_' + models_names[i] + '_dbscan.txt', index=None, sep='\t', mode='a')
...
for i in range(len(models)): 
    ...
    plt.savefig('clustering_outputs\SDbw_' + models_names[i] + '_dbscan.png')

    frame.to_csv(r'clustering_outputs\SDbw_' + models_names[i] + '_dbscan.txt', index=None, sep='\t', mode='a') 
    ...
    plt.xlabel('Epsilon')
    plt.ylabel('SDbw_wo')
    plt.title('DBSCAN_wo: The SDbw index - ' + models_names[i])
    plt.savefig('clustering_outputs\SDbw_wo_' + models_names[i] + '_dbscan.png')

    frame.to_csv(r'clustering_outputs\SDbw_wo_' + models_names[i] + '_dbscan.txt', index=None, sep='\t', mode='a')
...
for i in range(len(models)):
    for j in range(len(eps)):
        ...
        with open("clustering_outputs\index_" + models_names[i] + "_dbscan"+str(eps[j]).replace(".","")+".html","w") as fd:
            fd.write(html)
