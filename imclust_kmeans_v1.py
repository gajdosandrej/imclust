...
# imclust_kmeans_v1.py - extended version of imclust.py (by A. Gajdos)   
...
HELP = f"""
NAME
    imclust_kmeans_v1.py - image clustering demo

USAGE
    imclust_kmeans_v1.py [OPTIONS] DIRECTORY...

DESCRIPTION
    Image clusteuring demo imclust_kmeans_v1.py will cluster images in
...
for i in range(len(models)): 
    ...
    plt.savefig(output_dataset_path + '\MSC_' + models_names[i] + '_kmeans.png')
    
    frame.to_csv(output_dataset_path + '\MSC_' + models_names[i] + '_kmeans.txt' , index=None, sep='\t', mode='a')
...
for i in range(len(models)): 
    ...
    plt.savefig(output_dataset_path + '\CHS_' + models_names[i] + '_kmeans.png')

    frame.to_csv(output_dataset_path + '\CHS_' + models_names[i] + '_kmeans.txt', index=None, sep='\t', mode='a')
...
for i in range(len(models)): 
    ...
    plt.savefig(output_dataset_path + '\DBS_' + models_names[i] + '_kmeans.png')

    frame.to_csv(output_dataset_path + '\DBS_' + models_names[i] + '_kmeans.txt', index=None, sep='\t', mode='a')
...
for i in range(len(models)): 
    ...
    plt.savefig(output_dataset_path + '\COP_' + models_names[i] + '_kmeans.png')

    frame.to_csv(output_dataset_path + '\COP_' + models_names[i] + '_kmeans.txt', index=None, sep='\t', mode='a')
...
for i in range(len(models)): 
    ...
    plt.savefig(output_dataset_path + '\SDbw_' + models_names[i] + '_kmeans.png')

    frame.to_csv(output_dataset_path + '\SDbw_' + models_names[i] + '_kmeans.txt', index=None, sep='\t', mode='a')
...
for i in range(len(models)):
    for j in range(len(CLUSTERS)):
        ...
        with open(output_dataset_path + "\index_" + models_names[i] + "_kmeans"+str(CLUSTERS[j])+".html","w") as fd:
            fd.write(html)
